    ...
    while True:
        ...
        if choice == "1":
            while True:
                ...
                if sec_choice == "1":
                    input_folder = 'insert path to the folder containing the images'
                    output_folder = 'insert path to the folder where you want to save the list of corrupt images'
            ...
            while True:
                ...
                if sec_choice == "1":
                    file_path = 'insert path to the folder containing the images'
            ...
            while True:
                ...
                sec_choice = input("Enter your choice as a number: ")
                if sec_choice == "1":
                    train = 'insert path to the folder containing the images'
                    train_model(train)
                elif sec_choice == "2":
                    train = 'insert path to the folder containing the images'
                    ...
                    test_data = 'insert path to the folder containing the images'
                    saved_model = 'classifier_model.pth'
